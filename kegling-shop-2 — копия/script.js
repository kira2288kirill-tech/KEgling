...
function createProductCard(id, index = 0, options = {}) {
    ...
    card.innerHTML = `
        ...
        <img src="${product.img}" alt="${escapeHtml(product.title)}" style="object-position:${product.imagePosition || "center center"};">
...
function renderRelatedProducts(ids) {
    ...
    ids.forEach((id) => {
        ...
        card.innerHTML = `
            <img src="${product.img}" alt="${product.title}" style="object-position:${product.imagePosition || "center center"};">
